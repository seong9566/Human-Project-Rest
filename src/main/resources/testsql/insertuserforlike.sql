...
-- INSERT INTO alarm(users_id, alarm_message,alarm_company_like_id, alarm_check, created_at) VALUES(1, 'testCompany3 님이 회원님을 좋아요 했습니다.',1, false, now());
INSERT INTO resumes (resumes_title, resumes_picture, resumes_introduce,personal_id) VALUES('ㅎㅇ','사진임','ㅇㅇㅇㅇ',1);

INSERT INTO personal_like (resumes_id, company_id, created_at) VALUES(1,1,NOW());